...
FLAGS_use_stride_compute_kernel=False NNODES=${nnodes} MASTER_ADDR=${master} MASTER_PORT=${port} CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 coverage run -m paddleformers-cli train glm45.yaml
