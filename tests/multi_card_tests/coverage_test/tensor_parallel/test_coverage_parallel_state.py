...
class TestParallelState(unittest.TestCase):
    ...
    def test_tp_group_size(self):
        ...
        self.assertEqual(
            paddlefleet.parallel_state.get_tensor_model_parallel_world_size(),
            TP_SIZE,
        )
    ...
    def test_pp_group_size(self):
        ...
        self.assertEqual(
            paddlefleet.parallel_state.get_pipeline_model_parallel_world_size(),
            1,
        )

    def test_tp_rank_in_range(self):
        """Test TP rank is within valid range."""
        rank = paddlefleet.parallel_state.get_tensor_model_parallel_rank()
