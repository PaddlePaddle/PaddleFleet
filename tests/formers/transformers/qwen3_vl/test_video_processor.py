...
from paddlefleet.transformers import Qwen3VLVideoProcessor
from paddlefleet.transformers.image_utils import (
    OPENAI_CLIP_MEAN,
    OPENAI_CLIP_STD,
    get_image_size,
)
from paddlefleet.transformers.qwen3_vl.video_processor import smart_resize
