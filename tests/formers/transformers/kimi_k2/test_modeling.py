...
from paddlefleet.trainer import set_random_seed
from paddlefleet.transformers import KimiK2Config, KimiK2ForCausalLM
...
class KimiK2ModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    @unittest.skip(
        "TODO: Temporarily skipped because of PR https://github.com/PaddlePaddle/PaddleFleet/pull/4342 (fix later)"
    )
