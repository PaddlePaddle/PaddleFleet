...
from paddlefleet.transformers import AutoFeatureExtractor
from paddlefleet.transformers.audio_processing_utils import process_audio_info
from tests.formers.testing_utils import skip_for_none_ce_case
