...
from paddlefleet.transformers.cache_utils import DynamicCache

# from tests.formers.testing_utils import slow
...
from tests.formers.transformers.test_modeling_common import (
...
class MiniCPM4_1ModelTest(
    ...
    all_generative_model_classes = {
        MiniCPM4_1ForCausalLM: (MiniCPM4_1Model, "MiniCPM4_1")
    }
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=MiniCPM4_1Config, vocab_size=256, hidden_size=24
        )
    ...
    def test_dynamic_cache_two_step_decode(self):
        ...
        input_ids = paddle.to_tensor(
            [[1, 5, 9, 2, 7, 3, 4]], dtype=paddle.int64
        )
        prefix_length = 4
        ...
        with paddle.no_grad():
            full_logits = model(
                input_ids, use_cache=False, return_dict=True
            ).logits
        ...
        self.assertEqual(
            decode_outputs.past_key_values.get_seq_length(), input_ids.shape[1]
        )
        self.assertTrue(
            paddle.allclose(
