...
from paddlefleet.transformers.auto.configuration import CONFIG_MAPPING
from paddlefleet.transformers.qwen3.configuration import Qwen3Config
from paddlefleet.utils.env import CONFIG_NAME
...
class AutoConfigTest(unittest.TestCase):
    ...
    def test_new_config_registration(self):
        try:
            ...
            # Trying to register something existing in the PaddleFleet library will raise an error
            with self.assertRaises(ValueError):
