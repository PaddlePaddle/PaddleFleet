...
from tests.formers.testing_utils import gpu_device_initializer
...
from paddlefleet.generation import BeamSearchScorer, GenerationConfig
...
class Ernie4_5_VLModelTest(
    ...
    def _get_input_ids_and_config(self):
        ...
        # For test_sample_generate such as: NVIDIA_TF32_OVERRIDE=0 FLAGS_cudnn_deterministic=1 python3.10 -m pytest -svv tests/formers/transformers/bloom/test_modeling.py::BloomModelTest_0::test_sample_generate
