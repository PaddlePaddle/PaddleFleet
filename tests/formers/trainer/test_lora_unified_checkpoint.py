...
# from paddlefleet.utils.downloader import get_path_from_url_with_filelock
# from tests.formers.parallel_launch import TestMultipleGpus
# from tests.formers.testing_utils import require_paddle_at_least_8_gpu, skip_for_none_ce_case
# from tests.formers.trainer.trainer_utils import get_pretrain_arguments
