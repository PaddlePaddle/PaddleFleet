...
if [[ "$step" == "pt" ]]; then
    export config_yaml=$root_dir/PaddleFleet/tests/formers/config/ci/qwen3_multicard_pt.yaml
    ...
    export config_yaml=$root_dir/PaddleFleet/tests/formers/config/ci/qwen3_multicard_sft.yaml
    ...
    export config_yaml=$root_dir/PaddleFleet/tests/formers/config/ci/qwen3_multicard_lora.yaml
    export data_dir=$root_dir/PaddleFleet/tests/formers/fixtures/dummy/sft
