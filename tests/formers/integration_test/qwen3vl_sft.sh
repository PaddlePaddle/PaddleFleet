...
if [[ "$step" == "moe" ]]; then
    export config_yaml=$root_dir/PaddleFleet/tests/formers/config/ci/qwen3vl_sft_moe.yaml
    export data_dir=$root_dir/PaddleFleet/tests/formers/fixtures/dummy/sft-vl
    ...
    if [ $machine == "a100" ]; then
        export config_yaml=$root_dir/PaddleFleet/tests/formers/config/ci/qwen3vl_sft_moe_a100.yaml
    fi
elif [[ "$step" == "tp8" ]]; then
    export config_yaml=$root_dir/PaddleFleet/tests/formers/config/ci/qwen3vl_sft.yaml
    export data_dir=$root_dir/PaddleFleet/tests/formers/fixtures/dummy/sft-vl
    export model_name_or_path=$CACHE_DIR/qwen3vl/tiny-random-qwen3vlv2
    export output_dir=$root_dir/checkpoints/qwen3vl-sft
elif [ $step == "fsdp" ]; then
  export config_yaml=$root_dir/PaddleFleet/tests/formers/config/ci/qwen3vl_sft_fsdp.yaml
  export data_dir=$root_dir/PaddleFleet/tests/formers/fixtures/dummy/sft-vl
  export model_name_or_path=$CACHE_DIR/qwen3vl/tiny-random-qwen3vlv2
