...
config_yaml=$root_dir/PaddleFleet/tests/formers/config/ci/glm45_single_pt-test.yaml
...
if [ $exit_code -ne 0 ]; then
    ...
    python $root_dir/PaddleFleet/tests/formers/check_log_for_exitcode.py ./${log_file}
    check_exit_code=$?
