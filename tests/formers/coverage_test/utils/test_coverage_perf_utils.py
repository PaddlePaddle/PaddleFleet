...
class TestPerfUtils(unittest.TestCase):
    ...
    def test_register_profile_hook_layer(self):
        ...
        from paddlefleet.utils.perf_utils import register_profile_hook
    ...
    @patch("paddlefleet.utils.perf_utils._PROFILER_ENABLED", True)
    ...
    def test_time_cost_average(self):
        from paddlefleet.utils.tools import TimeCostAverage
