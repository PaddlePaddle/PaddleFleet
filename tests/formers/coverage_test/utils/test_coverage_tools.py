...
class TestToolsUtils(unittest.TestCase):
    ...
    def test_compare_version_equal(self):
        from paddlefleet.utils.tools import compare_version
    ...
    def test_get_bool_ids_greater_than_simple(self):
        ...
        from paddlefleet.utils.tools import get_bool_ids_greater_than
    ...
    def test_get_span_simple(self):
        from paddlefleet.utils.tools import get_span
    ...
    def test_dispatch_to(self):
        from paddlefleet.utils.tools import dispatch_to
    ...
    def test_device_guard_cpu(self):
        from paddlefleet.utils.tools import device_guard
