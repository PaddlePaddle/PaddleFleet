...
class TestEnvUtils(unittest.TestCase):
    ...
    def test_get_user_home(self):
        from paddlefleet.utils.env import _get_user_home
    ...
    def test_get_pf_home_env(self):
        from paddlefleet.utils.env import _get_pf_home
    ...
    def test_get_pf_home_no_env(self):
        ...
        with patch.dict(os.environ, env_copy, clear=True):
            with patch(
                "paddlefleet.utils.env._get_user_home", return_value="/tmp/user"
            ):
                result = _get_pf_home()
        self.assertEqual(result, "/tmp/user/.paddlefleet")

    def test_get_bool_env_true(self):
        from paddlefleet.utils.env import _get_bool_env
    ...
    def test_get_sub_home(self):
        from paddlefleet.utils.env import _get_sub_home
    ...
    def test_checkpoint_regex(self):
        from paddlefleet.utils.env import _re_checkpoint
