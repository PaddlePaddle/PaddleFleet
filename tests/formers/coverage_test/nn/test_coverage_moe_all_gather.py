...
class TestAllgatherAsync(unittest.TestCase):
    ...
    def _get_func(self):
        from paddlefleet.nn.moe.all_gather import allgather_async
...
class TestReduceScatterAsync(unittest.TestCase):
    ...
    def _get_func(self):
        from paddlefleet.nn.moe.all_gather import reduce_scatter_async
    ...
    @patch("paddlefleet.nn.moe.all_gather.dist.stream.reduce_scatter")
    @patch("paddlefleet.nn.moe.all_gather.fleet")
...
class TestAllGatherAsyncPyLayer(unittest.TestCase):
    ...
    def _get_cls(self):
        from paddlefleet.nn.moe.all_gather import AllGatherAsync
    ...
    @patch("paddlefleet.nn.moe.all_gather.reduce_scatter_async")
    @patch("paddlefleet.nn.moe.all_gather.manual_backward")
    @patch("paddlefleet.nn.moe.all_gather.dist.get_world_size", return_value=1)
...
class TestAlltoAllSmart(unittest.TestCase):
    ...
    def _get_cls(self):
        from paddlefleet.nn.moe.all_gather import AlltoAllSmart
    ...
    @patch("paddlefleet.nn.moe.all_gather.manual_backward")
    @patch("paddlefleet.nn.moe.all_gather.dist.stream.alltoall_single")
    @patch("paddlefleet.nn.moe.all_gather.dist.get_rank")
    @patch("paddlefleet.nn.moe.all_gather.dist.get_world_size")
    @patch("paddlefleet.nn.moe.all_gather._get_global_group")
...
class TestAlltoAllSmartXPU(unittest.TestCase):
    ...
    def _get_cls(self):
        from paddlefleet.nn.moe.all_gather import AlltoAllSmartXPU
