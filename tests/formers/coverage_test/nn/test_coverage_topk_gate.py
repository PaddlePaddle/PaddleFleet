...
class TestMaskedFill(unittest.TestCase):
    ...
    def setUp(self):
        from paddlefleet.nn.moe.topk_gate import masked_fill
...
class TestCastIfNeeded(unittest.TestCase):
    ...
    def setUp(self):
        from paddlefleet.nn.moe.topk_gate import cast_if_needed
...
class TestGateDetachMatmul(unittest.TestCase):
    ...
    def setUp(self):
        from paddlefleet.nn.moe.topk_gate import gate_detach_matmul
...
class TestFusedGateDetachMatmul(unittest.TestCase):
    ...
    def setUp(self):
        from paddlefleet.nn.moe.topk_gate import FusedGateDetachMatmul
...
class TestTopKGateInit(unittest.TestCase):
    ...
    def setUp(self):
        from paddlefleet.nn.moe.topk_gate import TopKGate
