...
class TestQuickAccessMoEFactory(unittest.TestCase):
    """Tests for paddlefleet.nn.moe_deepep.moe_factory.QuickAccessMoEFactory"""
    ...
    def test_create_from_model_name_calls_modular_moe_layer(self):
        ...
        with patch(
            "paddlefleet.nn.moe_deepep.moe_factory.ModularMoELayer"
        ) as mock_layer_cls:
    ...
    def test_create_from_model_name_is_static_method(self):
        ...
        self.assertTrue(
            callable(getattr(QuickAccessMoEFactory, "create_from_model_name"))
        )
        import inspect
