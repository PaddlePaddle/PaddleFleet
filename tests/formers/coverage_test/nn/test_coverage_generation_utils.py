...
class TestGetUnfinishedFlag(unittest.TestCase):
    """Tests for paddlefleet.generation.utils.get_unfinished_flag."""

    def test_single_eos_token_not_finished(self):
        """When last token is not eos, unfinished_flag should remain True."""
        from paddlefleet.generation.utils import get_unfinished_flag
...
class TestBeamHypotheses(unittest.TestCase):
    """Tests for paddlefleet.generation.utils.BeamHypotheses."""

    def test_init(self):
        """BeamHypotheses should initialize with empty beams."""
        from paddlefleet.generation.utils import BeamHypotheses
...
class TestMakeSlidingWindowMask(unittest.TestCase):
    """Tests for paddlefleet.generation.utils._make_sliding_window_mask."""

    def test_basic_shape(self):
        """Output shape should be [bsz, 1, tgt_seq_len, src_seq_len]."""
        from paddlefleet.generation.utils import _make_sliding_window_mask
...
class TestBeamSearchScorer(unittest.TestCase):
    """Tests for paddlefleet.generation.utils.BeamSearchScorer."""

    def test_init_validation_num_beams(self):
        """BeamSearchScorer should raise ValueError for num_beams <= 1."""
        from paddlefleet.generation.utils import BeamSearchScorer
