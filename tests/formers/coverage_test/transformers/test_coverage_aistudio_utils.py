...
class TestAistudioUtils(unittest.TestCase):
    """Tests for paddlefleet.transformers.aistudio_utils"""

    def test_unauthorized_error(self):
        """Test UnauthorizedError can be raised and caught."""
        from paddlefleet.transformers.aistudio_utils import UnauthorizedError
    ...
    def test_entry_not_found_error(self):
        ...
        from paddlefleet.transformers.aistudio_utils import EntryNotFoundError
    ...
    def test_add_subfolder_with_subfolder(self):
        ...
        from paddlefleet.transformers.aistudio_utils import _add_subfolder
    ...
    @patch("paddlefleet.transformers.aistudio_utils.download")
