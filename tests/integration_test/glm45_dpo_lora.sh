...
config_dpo_yaml=$root_dir/PaddleFleet/tests/config/ci/glm45_dpo_lora.yaml
...
if [ $sft_exit_code -ne 0 ]; then
   ...
   python $root_dir/PaddleFleet/tests/check_log_for_exitcode.py ./${log_file} "***** eval metrics *****"
   sft_check_exit_code=$?
