...
class TestExtensionsOpsFunctionCalls(unittest.TestCase):
    ...
    def test_fused_swiglu_scale_signature(self):
        ...
        from paddlefleet._extensions.ops import fused_swiglu_scale
    ...
    def test_fused_swiglu_scale_bwd_signature(self):
        ...
        from paddlefleet._extensions.ops import fused_swiglu_scale_bwd
    ...
    def test_filter_scores_signature(self):
        ...
        from paddlefleet._extensions.ops import filter_scores
    ...
    def test_router_metadata_signature(self):
        ...
        from paddlefleet._extensions.ops import router_metadata
    ...
    def test_count_cumsum_signature(self):
        ...
        from paddlefleet._extensions.ops import count_cumsum
    ...
    def test_tokens_zip_prob_signature(self):
        ...
        from paddlefleet._extensions.ops import tokens_zip_prob
    ...
    def test_merge_subbatch_cast_signature(self):
        ...
        from paddlefleet._extensions.ops import merge_subbatch_cast
    ...
    def test_tokens_zip_unique_add_signature(self):
        ...
        from paddlefleet._extensions.ops import tokens_zip_unique_add
...
class TestExtensionsInitModule(unittest.TestCase):
    ...
    def test_init_module_imports(self):
        ...
        from paddlefleet import _extensions
