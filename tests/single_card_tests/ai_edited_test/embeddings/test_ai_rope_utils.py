...
class TestGetPosEmbOnThisCPRank(unittest.TestCase):
    ...
    @patch(
        "paddlefleet.models.common.embeddings.rope_utils.get_pg_size",
        return_value=2,
    )
    @patch(
        "paddlefleet.models.common.embeddings.rope_utils.get_pg_rank",
        return_value=0,
    )
...
class TestRotateHalf(unittest.TestCase):
    ...
    def test_non_interleaved(self):
        from paddlefleet.models.common.embeddings.rope_utils import _rotate_half
...
class TestApplyRotaryPosEmbReroute(unittest.TestCase):
    ...
    def test_routes_to_thd(self):
        ...
        with patch(
            "paddlefleet.models.common.embeddings.rope_utils._apply_rotary_pos_emb_thd",
            return_value=t,
        ) as mock_thd:
            result = apply_rotary_pos_emb(
                t,
