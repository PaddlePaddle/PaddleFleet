...
class TestQwen3_5RMSNormEnableSP(unittest.TestCase):
    ...
    @patch(
        "paddlefleet.models.qwen3_5.qwen3_5_model.mark_as_sequence_parallel_parameter"
    )
...
class TestQwen3_5VisionModel(unittest.TestCase):
    ...
    @patch(
        "paddlefleet.models.qwen3_5.qwen3_5_model.TransformerEncoder.get_encoder_layer_desc_list"
    )
    @patch(
        "paddlefleet.models.qwen3_5.qwen3_5_model.TransformerEncoder.add_sequential_layer"
    )
