...
try:
    from paddlefleet.transformer.spec_utils import LayerSpec  # noqa: F401
...
class TestGetViTLayerWithLocalSpec(unittest.TestCase):
    ...
    @unittest.skipUnless(
        ...
        "paddlefleet.transformer.spec_utils.LayerSpec not available",
    )
    @unittest.skipUnless(
...
class TestViTLayerSpecsImports(unittest.TestCase):
    ...
    def test_ln_impl(self):
        from paddlefleet.fusions.fused_layer_norm import FusedLayerNorm
        from paddlefleet.models.vision.vit_layer_specs import LNImpl
