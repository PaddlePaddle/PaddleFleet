...
try:
    from paddlefleet.models.multimodal import llava_spec  # noqa: F401
...
class TestDecoderModelWithLocalDefaultSpec(unittest.TestCase):
    ...
    @unittest.skipUnless(
        ...
        "paddlefleet.models.multimodal.llava_spec cannot be imported (missing get_mlp_layer_spec in gpt_layer_specs)",
    )
    @patch("paddlefleet.models.multimodal.llava_spec.get_mlp_layer_spec")
    def test_returns_layer_spec(self, mock_mlp):
        from paddlefleet.models.multimodal.llava_spec import (
...
class TestLLaVASpecImports(unittest.TestCase):
    ...
    def test_import_ln_impl(self):
        ...
        from paddlefleet.models.multimodal.llava_spec import LNImpl
