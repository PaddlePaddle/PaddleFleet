...
class TestReduce(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.mappings.paddle.distributed.all_reduce")
...
class TestSplitAlongLastDim(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.mappings.split_tensor_along_last_dim")
...
class TestSplitAlongFirstDim(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.mappings.paddle.distributed")
...
class TestGatherAlongLastDim(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.mappings.dist.all_gather")
    ...
    @patch("paddlefleet.tensor_parallel.mappings.paddle.concat")
    @patch("paddlefleet.tensor_parallel.mappings.dist.all_gather")
...
class TestReduceScatterAlongLastDim(unittest.TestCase):
    ...
    @patch(
        "paddlefleet.tensor_parallel.mappings._reduce_scatter_along_first_dim"
    )
...
class TestReduceScatterAlongFirstDim(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.mappings._reduce_scatter_base")
...
class TestCopyToModelParallelRegion(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.mappings._reduce")
...
class TestScatterToModelParallelRegion(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.mappings._split_along_last_dim")
    ...
    @patch("paddlefleet.tensor_parallel.mappings._gather_along_last_dim")
...
class TestScatterToSequenceParallelRegion(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.mappings._split_along_first_dim")
...
class TestGatherFromSequenceParallelRegion(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.mappings._gather_along_first_dim")
    def test_forward_gathers(self, mock_gather):
