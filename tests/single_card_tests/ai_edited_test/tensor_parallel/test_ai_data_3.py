...
class TestBuildKeySizeNumelDictionaries(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.data.paddle.distributed.broadcast")
    @patch("paddlefleet.tensor_parallel.data.paddle.tensor")
    @patch(
        "paddlefleet.tensor_parallel.data.get_tensor_model_parallel_group_if_none"
    )
...
class TestBroadcastData(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.data.paddle.distributed.broadcast")
    @patch("paddlefleet.tensor_parallel.data.paddle.narrow")
    @patch(
        "paddlefleet.tensor_parallel.data.get_tensor_model_parallel_group_if_none"
    )
    @patch(
    ...
    @patch("paddlefleet.tensor_parallel.data.paddle.concat")
    @patch("paddlefleet.tensor_parallel.data.paddle.empty")
