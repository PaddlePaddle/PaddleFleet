...
class TestVocabParallelEmbeddingVocabRange(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.layers.get_pg_size", return_value=2)
    @patch("paddlefleet.tensor_parallel.layers.get_pg_rank", return_value=0)
    @patch(
    ...
    @patch("paddlefleet.tensor_parallel.layers.get_pg_size", return_value=2)
    @patch("paddlefleet.tensor_parallel.layers.get_pg_rank", return_value=1)
    @patch(
        "paddlefleet.tensor_parallel.layers.get_tensor_model_parallel_group_if_none"
    )
...
class TestVocabParallelEmbeddingShardedStateDict(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.layers.build_sharded_state_dict")
...
class TestVocabParallelEmbeddingReduceScatter(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.layers.get_pg_size", return_value=1)
    @patch(
        "paddlefleet.tensor_parallel.layers.get_tensor_model_parallel_group_if_none"
    )
...
class TestVocabParallelEmbeddingInitCPU(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.layers._initialize_affine_weight_cpu")
    @patch("paddlefleet.tensor_parallel.layers.get_pg_size", return_value=2)
    @patch("paddlefleet.tensor_parallel.layers.get_pg_rank", return_value=0)
    @patch(
        "paddlefleet.tensor_parallel.layers.get_tensor_model_parallel_group_if_none"
