...
class TestRefinedRcomputeFlashMaskCpAttentionForward(unittest.TestCase):
    ...
    @patch(
        "paddlefleet.refined_recompute.flash_attn.fleet.get_hybrid_communicate_group"
    )
...
class TestRefinedRcomputeFlashMaskCpAttentionCall(unittest.TestCase):
    ...
    @patch(
        "paddlefleet.refined_recompute.flash_attn.RefinedRcomputeFlashMaskCpAttention.forward"
    )
