...
| `test_ai_flash_attn_extra.py` | Tests for get_fa_version function / 测试 FA 版本获取函数 |
| `test_ai_flash_attn_extra2.py` | Tests for get_fa_version function / FA 版本获取函数额外测试 |
...
| `test_ai_flashattn_auto_cast.py` | Tests for get_fa_version with XPU device / XPU 设备下 FA 版本获取测试 |
