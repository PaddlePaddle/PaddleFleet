...
class TestRefinedRcomputeFlashMaskAttentionForward(unittest.TestCase):
    ...
    def test_second_fwd_dispatches(self, mock_tracer):
        ...
        with patch(
            "paddlefleet.refined_recompute.flash_attn.FlashMaskAttnFunctor.apply",
...
class TestFlashMaskAttnCpFunctorBackward(unittest.TestCase):
    ...
    @patch(
        "paddlefleet.refined_recompute.flash_attn.cp_flashmask_allgatherkv_balance_backward"
    )
...
class TestRefinedRcomputeFlashMaskAttentionCall(unittest.TestCase):
    ...
    @patch(
        "paddlefleet.refined_recompute.flash_attn.RefinedRcomputeFlashMaskAttention.forward"
    )
