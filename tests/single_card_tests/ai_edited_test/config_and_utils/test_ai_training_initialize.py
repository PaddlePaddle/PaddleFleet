...
class TestInitializeFleet(unittest.TestCase):
    ...
    def test_initialize_fleet_with_parsed_args(self):
        ...
        with mock.patch(  # noqa: SIM117
            "paddlefleet.training.initialize.set_global_variables"
        ) as mock_sg:
            with mock.patch(
                "paddlefleet.training.initialize.set_logging"
            ) as mock_sl:
                    ...
                    with mock.patch(
                        ...
                        with mock.patch(
                            ...
                            with mock.patch(
                                ...
                                with mock.patch(
                                    "paddlefleet.training.initialize.ps.initialize_model_parallel"
                                ):
                                    initialize_fleet(
    ...
    def test_initialize_fleet_without_parsed_args(self):
        ...
        with mock.patch(  # noqa: SIM117
            "paddlefleet.training.initialize.parse_args",
            return_value=mock_args,
        ) as mock_parse:
            with mock.patch(
                "paddlefleet.training.initialize.set_global_variables"
            ):
                with mock.patch("paddlefleet.training.initialize.set_logging"):
                    with mock.patch("paddle.distributed.fleet.init"):
                        with mock.patch(
                            "paddle.distributed.fleet.get_hybrid_communicate_group"
                        ):
    ...
    def test_initialize_fleet_calls_fleet_init(self):
        ...
        with mock.patch("paddlefleet.training.initialize.set_global_variables"):  # noqa: SIM117
            with mock.patch("paddlefleet.training.initialize.set_logging"):
...
class TestInitializeModuleStructure(unittest.TestCase):
    ...
    def test_module_exports(self):
        ...
        import paddlefleet.training.initialize as init_mod
