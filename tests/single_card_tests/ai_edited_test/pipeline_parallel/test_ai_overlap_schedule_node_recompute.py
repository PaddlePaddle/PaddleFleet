...
class TestOverlapScheduleNodeRecompute(unittest.TestCase):
    ...
    def test_forward_with_recompute(self):
        ...
        with (
            patch(
                "paddlefleet.pipeline_parallel.pp_utils.forward_backward_overlap_utils.switch_rng_state_tracker"
            ) as mock_switch,
            patch("paddle.amp.auto_cast"),
            patch("paddle.base.dygraph.guard"),
            patch(
                "paddlefleet.pipeline_parallel.pp_utils.forward_backward_overlap_utils.framework"
            ) as mock_fw,
            patch(
