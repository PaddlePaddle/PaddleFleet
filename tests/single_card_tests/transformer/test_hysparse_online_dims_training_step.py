...
class TestHySparseOnlineDimsTrainingStep(unittest.TestCase):
    ...
    def test_online_runtime_op_shapes(self):
        ...
        import paddlefleet.tilelang_ops.hysparse as hy_pkg
        import paddlefleet.tilelang_ops.hysparse.block_score_mha as bsm_mod
        import paddlefleet.tilelang_ops.hysparse.block_sparse_mqa_tl as bsp_mod
    ...
    def test_online_ff_runtime_op_shapes_packed(self):
        ...
        import paddlefleet.cudnn_ops as cudnn_pkg
        import paddlefleet.tilelang_ops.hysparse as hy_pkg
        import paddlefleet.tilelang_ops.hysparse.block_score_mha as bsm_mod
        import paddlefleet.tilelang_ops.hysparse.block_sparse_mqa_tl as bsp_mod
