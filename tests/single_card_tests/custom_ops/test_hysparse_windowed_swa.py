...
(:mod:`paddlefleet.tilelang_ops.hysparse.windowed_mqa_attn` fwd/bwd) and the
sliding-window attention wrapper it powers
(:mod:`paddlefleet.tilelang_ops.hysparse.swa_attn.sliding_window_mqa_attention`).
...
class TestWindowedMQAForward(unittest.TestCase):
    ...
    def test_full_causal_matches_dense(self):
        ...
        from paddlefleet.tilelang_ops.hysparse.windowed_mqa_attn import (
