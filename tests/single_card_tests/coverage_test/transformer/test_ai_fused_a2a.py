...
class TestBarrierEp(unittest.TestCase):
    ...
    @patch("paddlefleet.transformer.moe.fused_a2a.paddle.distributed.barrier")
...
class TestDispatchNode(unittest.TestCase):
    ...
    @patch("paddlefleet.transformer.moe.fused_a2a.fused_dispatch_forward_func")
    ...
    @patch("paddlefleet.transformer.moe.fused_a2a.fused_dispatch_forward_func")
    @patch("paddlefleet.transformer.moe.fused_a2a.fused_dispatch_backward_func")
...
class TestFusedDispatchForwardFunc(unittest.TestCase):
    ...
    @patch("paddlefleet.transformer.moe.fused_a2a.barrier_ep")
    @patch("paddlefleet.transformer.moe.fused_a2a.get_buffer")
