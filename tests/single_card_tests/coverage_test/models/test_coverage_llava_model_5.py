...
class TestPixelShuffle(unittest.TestCase):
    ...
    def test_pixel_shuffle_basic_shape(self):
        ...
        from paddlefleet.models.multimodal.llava_model import pixel_shuffle
...
class TestLLaVAModelConstants(unittest.TestCase):
    ...
    def test_ignore_index(self):
        from paddlefleet.models.multimodal.llava_model import IGNORE_INDEX
    ...
    def test_image_token(self):
        from paddlefleet.models.multimodal.llava_model import IMAGE_TOKEN

        self.assertEqual(IMAGE_TOKEN, "<image>")

    def test_video_token(self):
        from paddlefleet.models.multimodal.llava_model import VIDEO_TOKEN
...
class TestLLaVAModelInit(unittest.TestCase):
    ...
    @patch(
        "paddlefleet.models.multimodal.llava_model.has_config_logger_enabled",
        return_value=False,
    )
    @patch(
        "paddlefleet.models.multimodal.llava_model.get_num_image_embeddings",
        return_value=576,
    )
    @patch("paddlefleet.models.multimodal.llava_model.RADIOViTModel")
    @patch("paddlefleet.models.multimodal.llava_model.CLIPViTModel")
    @patch("paddlefleet.models.multimodal.llava_model.MultimodalProjector")
    @patch("paddlefleet.models.multimodal.llava_model.GPTModel")
