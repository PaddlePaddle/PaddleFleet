...
class TestCudaRNGStatesTrackerAdd(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.random.paddle.cuda.get_rng_state")
    @patch("paddlefleet.tensor_parallel.random.paddle.cuda.manual_seed")
    @patch("paddlefleet.tensor_parallel.random._set_cuda_rng_state")
...
class TestCudaRNGStatesTrackerFork(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.random._set_cuda_rng_state")
    @patch("paddlefleet.tensor_parallel.random._get_cuda_rng_state")
    @patch("paddlefleet.tensor_parallel.random.paddle.get_rng_state")
...
class TestSetCudaRNGState(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.random.paddle.cuda.set_rng_state")
...
class TestInitializeRNGTracker(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.random._CUDA_RNG_STATE_TRACKER", None)
    @patch(
    ...
    def test_initializes_tracker(self):
        ...
        import paddlefleet.tensor_parallel.random as random_mod
...
class TestModelParallelCudaManualSeed(unittest.TestCase):
    ...
    @patch(
        "paddlefleet.tensor_parallel.random.get_expert_tensor_parallel_rank",
        return_value=0,
    )
    @patch(
        "paddlefleet.tensor_parallel.random.get_expert_model_parallel_rank",
        return_value=0,
    )
    @patch(
        "paddlefleet.tensor_parallel.random.get_tensor_model_parallel_rank",
        return_value=0,
    )
    @patch("paddlefleet.tensor_parallel.random.initialize_rng_tracker")
    @patch("paddlefleet.tensor_parallel.random.paddle.cuda.manual_seed")
...
class TestForkRNG(unittest.TestCase):
    ...
    @patch("paddlefleet.tensor_parallel.random._set_all_rng_states")
    @patch("paddlefleet.tensor_parallel.random._get_all_rng_states")
