...
class TestVocabParallelCrossEntropyForward(unittest.TestCase):
    ...
    @patch(
        "paddlefleet.tensor_parallel.cross_entropy.get_tensor_model_parallel_rank",
        return_value=0,
    )
    @patch(
        "paddlefleet.tensor_parallel.cross_entropy.get_tensor_model_parallel_world_size",
        return_value=1,
    )
