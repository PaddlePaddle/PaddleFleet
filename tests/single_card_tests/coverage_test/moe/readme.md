...
| `test_coverage_moe_fp8_utils.py` | Unit tests for fp8_utils module / 测试 MoE FP8 工具模块 |
| `test_coverage_moe_layer.py` | Unit tests for moe_layer module / 测试 MoE 层模块 |
| `test_coverage_moe_layer_extra.py` | Extra tests for MoELayer expert parallel initialization / MoE 层专家并行初始化额外测试 |
