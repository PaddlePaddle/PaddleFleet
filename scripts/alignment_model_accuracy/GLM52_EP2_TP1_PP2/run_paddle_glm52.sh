...
export MODEL_REPRO_IEEE_KERNEL=1 MODEL_REPRO_FP32_UAC_GATE=1
export MODEL_REPRO_TWO_FP32_ACCUM=1 MODEL_REPRO_DISABLE_LIVE_XY_DUMP=1
export MODEL_REPRO_BIAS_ACTIVATION_FUSION=0
export MODEL_REPRO_OVERLAP_P2P_COMM=0 MODEL_REPRO_BATCH_P2P_COMM=1
