...
readonly MEGATRON_CORE_WHEEL="${MEGATRON_CORE_WHEEL_PATH:-https://paddle-github-action.bj.bcebos.com/whl/megatron_core-0.0.0-cp312-cp312-linux_x86_64.whl}"
readonly MS_SWIFT_WHEEL="${MS_SWIFT_WHEEL_PATH:-https://paddle-github-action.bj.bcebos.com/whl/ms_swift-0.0.0-py3-none-any.whl}"
