...
MEGATRON_CORE_WHEEL="${MEGATRON_CORE_WHEEL_PATH:-${FLEET_WHL_BASE}/megatron_core-0.0.0-cp312-cp312-linux_x86_64.whl}"
readonly MS_SWIFT_WHEEL="${MS_SWIFT_WHEEL_PATH:-${FLEET_WHL_BASE}/ms_swift-0.0.0-py3-none-any.whl}"
