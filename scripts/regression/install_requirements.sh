...
install_requirements() {
    ...
    if [[ "$ce_branch" == "CE_Develop_cu132_py312" ]]; then # nightly regerssion
        ...
        pip install -e . --no-build-isolation  --extra-index-url=https://www.paddlepaddle.org.cn/packages/nightly/${CUDA_VERSION}/ --extra-index-url https://www.paddlepaddle.org.cn/packages/stable/${CUDA_VERSION}/
        #paddle develop
