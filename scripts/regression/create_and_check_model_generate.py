...
MODEL_MAPPING = {
    "glm4_moe": {
        "import_path": "paddlefleet.transformers.glm4_moe.modeling",
        "class_name": "Glm4MoeForCausalLMDeprecated",
        "dtype": "bfloat16",
    },
    "qwen3_next": {
        "import_path": "paddlefleet.transformers.qwen3_next.modeling",
        "class_name": "Qwen3NextForCausalLM",
        "dtype": "float32",
    },
    "gemma3_text": {
        "import_path": "paddlefleet.transformers.gemma3_text.modeling",
        "class_name": "Gemma3ForCausalLM",
        "dtype": "bfloat16",
    },
    "gpt_oss": {
        "import_path": "paddlefleet.transformers.gpt_oss.modeling",
        "class_name": "GptOssForCausalLM",
        "dtype": "bfloat16",
    },
    "qwen3moe": {
        "import_path": "paddlefleet.transformers",
        "class_name": "Qwen3MoeForCausalLMDeprecated",
        "dtype": "float32",
    },
    "phi3": {
        "import_path": "paddlefleet.transformers.phi3.modeling",
        "class_name": "Phi3ForCausalLM",
        "dtype": "bfloat16",
    },
    "llama": {
        "import_path": "paddlefleet.transformers.llama.modeling",
        "class_name": "LlamaForCausalLM",
        "dtype": "bfloat16",
    },
    "deepseek_v3": {
        "import_path": "paddlefleet.transformers.deepseek_v3.modeling",
    ...
    "qwen3": {
        "import_path": "paddlefleet.transformers.qwen3.modeling",
        "class_name": "Qwen3ForCausalLMDeprecated",
        "dtype": "bfloat16",
    },
    "qwen2": {
        "import_path": "paddlefleet.transformers.qwen2.modeling",
        "class_name": "Qwen2ForCausalLM",
        "dtype": "bfloat16",
    },
    "ernie4_5_moe": {
        "import_path": "paddlefleet.transformers.ernie4_5_moe.modeling",
        "class_name": "Ernie4_5_MoeForCausalLM",
        "dtype": "bfloat16",
    },
    "ernie4_5": {
        "import_path": "paddlefleet.transformers.ernie4_5.modeling",
        "class_name": "Ernie4_5ForCausalLM",
        "dtype": "bfloat16",
    },
    "ernie4_5_moe_vl": {
        "import_path": "paddlefleet.transformers.ernie4_5_moe_vl.model.modeling_moe",
        "class_name": "Ernie4_5_MoeForCausalLM",
        "dtype": "bfloat16",
    },
    "paddleocr_vl": {
