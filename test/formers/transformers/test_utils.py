...
from paddlefleet.transformers import Qwen3Model, utils
from paddlefleet.transformers.qwen3.modeling import Qwen3ForTokenClassification


class TestUtils(unittest.TestCase):
    """Unittest for paddlefleet.transformers.utils.py module"""
