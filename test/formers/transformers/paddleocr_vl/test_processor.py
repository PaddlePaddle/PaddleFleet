...
from paddlefleet.transformers import AutoProcessor, PaddleOCRVLProcessor
...
class PaddleOCRVLProcessorTest(ProcessorTesterMixin, unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        processor = PaddleOCRVLProcessor.from_pretrained(
            "PaddleFleet/tiny-random-paddleocr-vl-bf16", patch_size=4, max_pixels=56 * 56, min_pixels=28 * 28
        )
