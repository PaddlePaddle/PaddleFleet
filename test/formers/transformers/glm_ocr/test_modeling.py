...
from formers.transformers.test_modeling_common import ModelTesterMixin, floats_tensor
...
class GlmOcrModelTester:
    ...
    def get_config(self) -> GlmOcrConfig:
        from paddlefleet.transformers import GlmOcrTextConfig, GlmOcrVisionConfig
