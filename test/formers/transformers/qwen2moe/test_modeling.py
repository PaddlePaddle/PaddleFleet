...
from paddlefleet.transformers import Qwen2MoeConfig
from paddlefleet.transformers import (
    Qwen2MoeForCausalLMDeprecated as Qwen2MoeForCausalLM,
)
from paddlefleet.transformers import Qwen2MoeModel
...
class Qwen2MoeIntegrationTest(unittest.TestCase):
    ...
    def test_model_tiny_logits(self):
        ...
        model = Qwen2MoeForCausalLM.from_pretrained(
            "PaddleFleet/tiny-random-qwen2moev2",
            dtype="float32",
...
class Qwen2MoeGenerationD2STest(GenerationD2STestMixin, unittest.TestCase):
    internal_testing_model = "PaddleFleet/tiny-random-qwen2moev2"
