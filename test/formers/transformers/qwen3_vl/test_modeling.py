...
from paddlefleet.transformers import AutoProcessor, Qwen3VLConfig
from paddlefleet.transformers import (
    Qwen3VLForConditionalGenerationDeprecated as Qwen3VLForConditionalGeneration,
)
from paddlefleet.transformers import Qwen3VLModelDeprecated as Qwen3VLModel
from paddlefleet.transformers import process_vision_info
from paddlefleet.transformers.video_utils import load_video
...
class Qwen3VLIntegrationTest(unittest.TestCase):
    ...
    def setUp(self):
        self.model = Qwen3VLForConditionalGeneration.from_pretrained(
            "PaddleFleet/tiny-random-qwen3vl",
            dtype="float32",
            load_checkpoint_format="flex_checkpoint",
        )

        self.processor = AutoProcessor.from_pretrained("PaddleFleet/tiny-random-qwen3vl")
        self.messages = [
            {
                "role": "user",
                "content": [
...
class Qwen3VLCompatibilityTest(unittest.TestCase):
    ...
    def test_Qwen3VL_classes_from_local_dir(self, class_name, pytorch_class_name: str | None = None):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            # 2. forward the paddle model
            from paddlefleet import transformers
