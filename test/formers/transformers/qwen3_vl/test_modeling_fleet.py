...
try:
    from paddlefleet.transformers.qwen3_vl.modeling import (
        Qwen3VLVisionRotaryEmbedding,
    )
    from paddlefleet.transformers.qwen3_vl.modeling_fleet import (
        Qwen3VLVisionModel,
...
@unittest.skipUnless(
    ...
    f"paddlefleet import failed: {_FLEET_IMPORT_ERROR}",
)
