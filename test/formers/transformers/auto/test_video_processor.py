...
from paddlefleet.transformers import AutoVideoProcessor, Qwen2VLVideoProcessor


class AutoVideoProcessorTest(unittest.TestCase):
    def test_video_processor_from_pretrained(self):
        processor = AutoVideoProcessor.from_pretrained("PaddleFleet/tiny-random-qwen25vlv2")
    ...
    def test_video_processor_save_pretrained(self):
        config_dict = AutoVideoProcessor.from_pretrained("PaddleFleet/tiny-random-qwen25vlv2").to_dict()
