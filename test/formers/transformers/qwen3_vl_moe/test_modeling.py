...
from paddlefleet.transformers import AutoProcessor, Qwen3VLMoeConfig
from paddlefleet.transformers import (
    Qwen3VLMoeForConditionalGenerationDeprecated as Qwen3VLMoeForConditionalGeneration,
)
from paddlefleet.transformers import Qwen3VLMoeModelDeprecated as Qwen3VLMoeModel
...
class Qwen3VLMoeIntegrationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.processor = AutoProcessor.from_pretrained("PaddleFleet/tiny-random-qwen3vlmoev2")
        self.messages = [
            {
                "role": "user",
                "content": [
