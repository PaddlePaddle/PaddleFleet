...
config_dpo_yaml=$root_dir/PaddleFleet/test/formers/config/ci/glm45_dpo_lora.yaml
...
if [ $sft_exit_code -ne 0 ]; then
   ...
   python $root_dir/PaddleFleet/test/formers/check_log_for_exitcode.py ./${log_file} "***** eval metrics *****"
   sft_check_exit_code=$?
