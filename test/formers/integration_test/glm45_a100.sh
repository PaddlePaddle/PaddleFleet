...
if [[ ${step} == "pt" ]]; then
  ...
  config_yaml=$root_dir/PaddleFleet/test/formers/config/ci/glm45_pt.yaml
  export data_dir=$root_dir/PaddleFleet/test/formers/fixtures/dummy/pt
  ...
  config_yaml=$root_dir/PaddleFleet/test/formers/config/ci/glm45_sft.yaml
  export data_dir=$root_dir/PaddleFleet/test/formers/fixtures/dummy/sft
  ...
  config_yaml=$root_dir/PaddleFleet/test/formers/config/ci/glm45_lora.yaml
  export data_dir=$root_dir/PaddleFleet/test/formers/fixtures/dummy/sft
  ...
  config_yaml=$root_dir/PaddleFleet/test/formers/config/ci/glm45_dpo.yaml
  export data_dir=$root_dir/PaddleFleet/test/formers/fixtures/dummy/dpo
  yq '.train_dataset_path = strenv(data_dir) + "/train.jsonl"
      | .eval_dataset_path = strenv(data_dir) + "/eval.jsonl"
      | .model_name_or_path = strenv(cur_dir) + "/checkpoints/glm_full_pp_ckpts"
  ...
  export data_dir=$root_dir/PaddleFleet/test/formers/fixtures/dummy/dpo
  config_yaml=$root_dir/PaddleFleet/test/formers/config/ci/glm45_dpo_lora.yaml
...
if [ $exit_code -ne 0 ]; then
    ...
    python $root_dir/PaddleFleet/test/formers/check_log_for_exitcode.py ./${log_file} "***** train metrics *****"
    check_log_exit_code=$?
