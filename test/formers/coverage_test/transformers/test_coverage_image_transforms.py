...
class TestIsPaddleTensor(unittest.TestCase):
    ...
    def test_paddle_tensor(self):
        from paddlefleet.transformers.image_transforms import is_paddle_tensor
...
class TestRescale(unittest.TestCase):
    ...
    def test_basic_rescale(self):
        from paddlefleet.transformers.image_transforms import rescale
...
class TestToPilImage(unittest.TestCase):
    ...
    def test_pil_image_passthrough(self):
        from paddlefleet.transformers.image_transforms import to_pil_image
...
class TestRgbToId(unittest.TestCase):
    ...
    def test_scalar_rgb_to_id(self):
        from paddlefleet.transformers.image_transforms import rgb_to_id
    ...
    def test_id_to_rgb_scalar(self):
        from paddlefleet.transformers.image_transforms import id_to_rgb
...
class TestPaddingMode(unittest.TestCase):
    ...
    def test_constant(self):
        from paddlefleet.transformers.image_transforms import PaddingMode
...
class TestConvertToRgb(unittest.TestCase):
    ...
    def test_pil_rgb_passthrough(self):
        from paddlefleet.transformers.image_transforms import convert_to_rgb
