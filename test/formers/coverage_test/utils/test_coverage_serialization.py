...
class TestSerialization(unittest.TestCase):
    ...
    def test_SerializationError(self):
        from paddlefleet.utils.serialization import SerializationError

        with self.assertRaises(SerializationError):
            raise SerializationError("test error")

    def test_maybe_decode_ascii_bytes(self):
        from paddlefleet.utils.serialization import _maybe_decode_ascii
    ...
    def test_StorageType(self):
        from paddlefleet.utils.serialization import StorageType
    ...
    def test_element_size_float(self):
        ...
        from paddlefleet.utils.serialization import _element_size
    ...
    def test_rebuild_tensor_stage_c_order(self):
        ...
        from paddlefleet.utils.serialization import _rebuild_tensor_stage
    ...
    def test_rebuild_parameter(self):
        ...
        from paddlefleet.utils.serialization import _rebuild_parameter
    ...
    def test_dumpy(self):
        from paddlefleet.utils.serialization import dumpy
    ...
    def test_SafeUnpickler_allowed(self):
        ...
        from paddlefleet.utils.serialization import SafeUnpickler
    ...
    def test_Types_dict(self):
        from paddlefleet.utils.serialization import _TYPES
