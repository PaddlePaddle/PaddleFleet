...
class TestDistributed(unittest.TestCase):
    ...
    def test_convert_file_size_to_int_int(self):
        from paddlefleet.utils.distributed import convert_file_size_to_int
    ...
    def test_dtype_byte_size_bool(self):
        ...
        from paddlefleet.utils.distributed import dtype_byte_size
    ...
    def test_reduce_tensor(self):
        ...
        from paddlefleet.utils.distributed import reduce_tensor

        x = paddle.randn([4, 8], dtype="float32")
        with patch(
            "paddlefleet.utils.distributed.convert_file_size_to_int",
            return_value=1024,
        ):
    ...
    def test_dtype_byte_size_invalid(self):
        with patch("paddlefleet.utils.distributed.re") as mock_re:
