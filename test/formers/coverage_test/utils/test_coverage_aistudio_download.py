...
class TestGetTokenFromFile(unittest.TestCase):
    def test_file_not_found(self):
        with patch(
            "paddlefleet.utils.download.aistudio_hub_download.AISTUDIO_TOKEN_PATH",
            "/nonexistent/path",
        ):
...
class TestGetTokenToSend(unittest.TestCase):
    ...
    def test_true_no_cached_token_raises(self):
        with patch(
            "paddlefleet.utils.download.aistudio_hub_download.get_token",
            return_value=None,
        ):
...
class TestBuildAistudioHeaders(unittest.TestCase):
    def test_no_token(self):
        with patch(
            "paddlefleet.utils.download.aistudio_hub_download.get_token_to_send",
            return_value=None,
        ):
