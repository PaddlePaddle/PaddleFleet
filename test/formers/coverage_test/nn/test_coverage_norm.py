...
class TestLayerNorm(unittest.TestCase):
    """Tests for paddlefleet.nn.norm.LayerNorm."""
    ...
    def test_layer_norm_forward_shape(self):
        ...
        from paddlefleet.nn.norm import LayerNorm
...
class TestRMSNorm(unittest.TestCase):
    """Tests for paddlefleet.nn.norm.RMSNorm."""
    ...
    @patch("paddlefleet.nn.norm.detect_device", return_value="gpu")
    @patch("paddlefleet.nn.norm.fused_rms_norm_ext")
    def test_rms_norm_forward_shape_with_fused(self, mock_fused, mock_device):
        ...
        from paddlefleet.nn.norm import RMSNorm
...
class TestNorm(unittest.TestCase):
    """Tests for paddlefleet.nn.norm.Norm factory."""
    ...
    def test_norm_create_default_rms(self):
        ...
        from paddlefleet.nn.norm import Norm, RMSNorm
    ...
    def test_norm_create_layer_norm(self):
        ...
        from paddlefleet.nn.norm import LayerNorm, Norm
    ...
    def test_norm_create_custom_hidden_size(self):
        ...
        from paddlefleet.nn.norm import Norm
