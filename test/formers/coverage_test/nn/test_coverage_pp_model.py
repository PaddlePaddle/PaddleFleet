...
class TestParseArgs(unittest.TestCase):
    ...
    def _get_parse_args(self):
        from paddlefleet.nn.pp_model import parse_args
...
class TestGetPPVPSplitLayers(unittest.TestCase):
    ...
    def _get_func(self):
        from paddlefleet.nn.pp_model import get_pp_vp_split_layers

        return get_pp_vp_split_layers

    @patch("paddlefleet.nn.pp_model.get_hcg")
...
class TestGetAttr(unittest.TestCase):
    ...
    def _get_func(self):
        from paddlefleet.nn.pp_model import get_attr
...
class TestRotaryEmbedding(unittest.TestCase):
    ...
    def _get_cls(self):
        from paddlefleet.nn.pp_model import RotaryEmbedding
...
class TestEmptyLayer(unittest.TestCase):
    ...
    def _get_cls(self):
        from paddlefleet.nn.pp_model import EmptyLayer
...
class TestRMSNormPipe(unittest.TestCase):
    ...
    def test_init_with_sequence_parallel(self):
        ...
        from paddlefleet.nn.pp_model import RMSNormPipe
...
class TestLayerNormPipe(unittest.TestCase):
    ...
    def test_init_with_sequence_parallel(self):
        ...
        from paddlefleet.nn.pp_model import LayerNormPipe
...
class TestLMHeadPipe(unittest.TestCase):
    ...
    def test_embedding_weight_property(self):
        ...
        from paddlefleet.nn.pp_model import LMHeadPipe
...
class TestMakeDecoderLayerPipe(unittest.TestCase):
    ...
    def test_returns_type_with_correct_name(self):
        ...
        from paddlefleet.nn.pp_model import make_decoder_layer_pipe
...
class TestCriterionLayerPipe(unittest.TestCase):
    ...
    def test_return_tuple_default(self):
        ...
        from paddlefleet.nn.pp_model import CriterionLayerPipe
