...
class TestCreateMoeBlock(unittest.TestCase):
    ...
    @patch("paddlefleet.nn.moe.moe_block.MOEAllGatherLayerV2")
    ...
    @patch("paddlefleet.nn.moe.moe_block.MOEAlltoAllLayer")
...
class TestMoEStatics(unittest.TestCase):
    ...
    def _get_cls(self):
        from paddlefleet.nn.moe.moe_block import MoEStatics
