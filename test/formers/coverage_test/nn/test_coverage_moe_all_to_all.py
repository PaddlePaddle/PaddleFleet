...
class TestAlltoAllPyLayer(unittest.TestCase):
    ...
    def _get_cls(self):
        from paddlefleet.nn.moe.all_to_all import AlltoAll
...
class TestAlltoAllAsync(unittest.TestCase):
    ...
    def _get_cls(self):
        from paddlefleet.nn.moe.all_to_all import AlltoAllAsync
...
class TestAlltoAllInputValidation(unittest.TestCase):
    ...
    @patch("paddlefleet.nn.moe.all_to_all.stream.alltoall_single")
    @patch("paddlefleet.nn.moe.all_to_all.dist.get_world_size", return_value=2)
