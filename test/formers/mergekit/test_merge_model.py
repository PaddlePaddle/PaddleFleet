...
from formers.testing_utils import require_package
...
class TestMergeModel(unittest.TestCase):
    ...
    def test_fuse_qkv_lora_merge_torch(self):
        with TemporaryDirectory() as tempdir:
            ...
            from paddlefleet.transformers import Qwen3Config, Qwen3ForCausalLM
            ...
            # create lora model
            from paddlefleet.cli.utils import get_lora_target_modules
