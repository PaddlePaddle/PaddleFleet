...
from .config_rrattn import RRAttnConfig, get_rrattn_config
...
@triton.jit
def rrattn_v1_gemm_qchunk_gqa_kernel(
    Q,
    K,
    Out,
    seqlen_q,
...
@triton.jit
def rrattn_v1_nomask_softmax_reduce_kernel(
    In,
    Out,
    OutBoundaryMask,
    scale,
...
@triton.jit
def rrattn_v1_flashmask_softmax_reduce_qchunk_kernel(
    In,
    Out,
    OutBoundaryMask,
    lt_start_nstridemax,
...
def _launch_qchunk_two_kernel(
    ...
    *,
    ...
    for chunk_q_start in range(0, n_q_strides, max_chunk_q_strides):
        ...
        rrattn_v1_gemm_qchunk_gqa_kernel[grid_gemm](
            q,
            k,
            intermediate,
            seqlen_q=q_len,
        ...
        if mask_ctx is None:
            rrattn_v1_nomask_softmax_reduce_kernel[grid_output](
                intermediate,
                attn_sums,
            ...
            rrattn_v1_flashmask_softmax_reduce_qchunk_kernel[grid_output](
                intermediate,
                attn_sums,
                boundary_protection_mask,
