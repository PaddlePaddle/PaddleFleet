...
DATASETS_MODULE_PATH = "paddlefleet.datasets."
...
def load_from_ppnlp(path, *args, **kwargs):
    ppnlp_path = paddlefleet.datasets.__path__[0]
...
def load_dataset(
    ...
    **kwargs,
    ...
    """
    This method will load a dataset, either form PaddleFleet library or from a
