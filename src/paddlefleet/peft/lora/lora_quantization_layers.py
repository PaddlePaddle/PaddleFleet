...
class QuantizationLoRALinear(QuantizationLoRABaseLinear):
    ...
    https://github.com/PaddlePaddle/PaddleFleet/blob/develop/paddlefleet/peft/lora/lora_layers.py
...
class ColumnParallelQuantizationLoRALinear(QuantizationLoRABaseLinear):
    ...
    https://github.com/PaddlePaddle/PaddleFleet/blob/develop/paddlefleet/peft/lora/lora_layers.py#L203
...
class RowParallelQuantizationLoRALinear(QuantizationLoRABaseLinear):
    ...
    https://github.com/PaddlePaddle/PaddleFleet/blob/develop/paddlefleet/peft/lora/lora_layers.py#L99
