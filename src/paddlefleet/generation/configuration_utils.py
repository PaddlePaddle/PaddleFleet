...
class GenerationConfig:
    ...
    def __init__(self, **kwargs):
        ...
        self.paddlefleet_version = kwargs.pop(
            "paddlefleet_version", __version__
        )
    ...
    def __eq__(self, other):
        ...
        # ignore metadata
        for metadata_field in ["_from_model_config", "paddlefleet_version"]:
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from paddlefleet.transformers import GenerationConfig
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        # PaddleFleet version when serializing this file
