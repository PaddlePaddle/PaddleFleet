...
class ModelArguments:
    ...
    continue_training: bool = field(
        ...
        metadata={
            "help": (
                "Whether to train from existing paddlefleet model weights.\n"
                "If set True, the model_path argument must exist in the paddlefleet models."
            )
        },
    )
    stage: str = field(
    ...
    rope_3d: Optional[bool] = field(
        default=True, metadata={"help": "use rope3d"}
    )
    ...
    persist_layer_norm: Optional[bool] = field(
        default=None,
        metadata={
            "help": "Override the Fleet provider persistent layer-norm implementation."
        },
    )
