...
from paddlefleet.nn.criterion import CriterionLayer
from paddlefleet.peft import LoRAModel
from paddlefleet.peft.lora.lora_model import AVAILABLE_LAYERS
...
from paddlefleet.utils.import_utils import is_paddlefleet_available
        ...
        **kwargs,
        ...
        if not model_with_dpo_criterion:
            if dpo_criterion is None:
                ...
                raise ValueError(
                    "dpo_criterion should be None or DPOCriterion. Got {}".format(
                        type(dpo_criterion)
                    )
                )
