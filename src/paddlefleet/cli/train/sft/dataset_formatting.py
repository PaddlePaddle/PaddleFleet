...
def paddlefleet_instructions_formatting_function(tokenizer: AutoTokenizer):
    r"""
    return a callable function that takes in an "instructions" dataset and returns a formatted dataset, based on the tokenizer
    apply chat template to the dataset
    """
...
def get_formatting_func_from_dataset(
    ...
    if isinstance(dataset, Dataset):
        ...
        elif dataset.features == FORMAT_MAPPING["paddlefleet"]:
            return paddlefleet_instructions_formatting_function(tokenizer)
