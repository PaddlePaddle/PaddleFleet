...
from paddlefleet.trainer import Trainer, TrainingArguments, speed_metrics
from paddlefleet.utils.tools import get_env_device

try:
    from paddlefleet.trainer import TRAINING_ARGS_NAME
except ImportError:
    TRAINING_ARGS_NAME = "training_args.bin"

try:
    from paddlefleet.utils.env import PADDLE_OPTIMIZER_NAME
except ImportError:
    from paddlefleet.trainer.trainer import OPTIMIZER_NAME
...
try:
    ...
    from paddlefleet.utils.env import PADDLE_WEIGHTS_NAME
...
from paddlefleet.cli.train.ernie_pretrain.src.callbacks.moe_logging_callback import (
    MoeLoggingCallback,
)
from paddlefleet.cli.train.ernie_pretrain.src.clip import (
    ClipGradForMOEByGlobalNorm,
)
from paddlefleet.cli.train.ernie_pretrain.src.lr_schedulers import (
    get_wsd_schedule_with_warmup,
)
from paddlefleet.cli.train.ernie_pretrain.src.trainers.data_parallel import (
...
from paddlefleet.datasets import MapDataset
from paddlefleet.trainer.trainer_callback import PrinterCallback
from paddlefleet.trainer.trainer_utils import ShardingOption
from paddlefleet.trainer.utils import add_start_docstrings
from paddlefleet.transformers.model_utils import _add_variant, unwrap_model
from paddlefleet.utils.batch_sampler import (
...
def distributed_optimizer_maybe_overwrite(
    ...
    if use_moe:
        from paddlefleet.cli.train.ernie_pretrain.src.trainers.dygraph_optimizer.hybrid_parallel_optimizer import (
...
class PreTrainingArguments(TrainingArguments):
    ...
    model_name_or_path: str = field(
        ...
        metadata={
            ...
            "https://paddlefleet.readthedocs.io/zh/latest/model_zoo/transformers.html"
        },
    )
...
class PretrainingTrainer(Trainer):
    ...
    def create_scheduler(self, num_training_steps):
        ...
        if getattr(self.args, "freeze_training", False):
            ...
            from paddlefleet.trainer.trainer_utils import get_constant_schedule
