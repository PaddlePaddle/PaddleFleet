...
from paddlefleet.cli.train.ernie_pretrain.src.utils import logger
from paddlefleet.utils.tools import get_env_device, paddle_device
...
from paddlefleet.trainer import PdArgumentParser, get_last_checkpoint

try:
    from paddlefleet.utils.downloader import get_static_model_on_pdc
except ImportError:
...
from paddlefleet.cli.train.ernie_pretrain.models.ernie import ErnieMoEConfig
from paddlefleet.cli.train.ernie_pretrain.models.ernie.modeling_moe import (
    ErnieMoEForCausalLM,
)
from paddlefleet.cli.train.ernie_pretrain.models.ernie.modeling_pp import (
...
from paddlefleet.cli.train.ernie_pretrain.src.trainers import (
...
from paddlefleet.trainer.unified_checkpoint import unified_checkpoint
from paddlefleet.transformers.model_utils import unwrap_model

try:
    from paddlefleet.trainer.trainer_utils import log_trainer_start
except ImportError:
...
def run_ernie_pretrain(model_args, data_args, generating_args, training_args):
    ...
    def register_pp_reshard_information(num_hidden_layers):
        from paddlefleet.trainer.utils.reshard.pp_reshard import (
