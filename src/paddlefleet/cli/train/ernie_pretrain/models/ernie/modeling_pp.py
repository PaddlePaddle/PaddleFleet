...
from paddlefleet.cli.train.ernie_pretrain.models.moe.moe_layer import MOELayer
...
from paddlefleet.cli.train.ernie_pretrain.models.utils import inplace_offload
