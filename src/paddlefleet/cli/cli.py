...
USAGE = (
    ...
    + "\n"
    + "| Usage:                                                              |\n"
    + "|   paddlefleet-cli train -h: model finetuning                      |\n"
    + "|   paddlefleet-cli export -h: model export                         |\n"
    + "|   paddlefleet-cli version: show version info                      |\n"
    + "|   paddlefleet-cli help: show helping info                         |\n"
    + "-" * 60
)


WELCOME = "-" * 60 + "\n" + "Welcome to PaddleFleet Cli" + "\n" + "-" * 60
...
def main():
    ...
    paddlefleet_dist_log = os.getenv(
        "PADDLEFLEET_DIST_LOG", "paddlefleet_dist_log"
    )
    ...
    if command in distributed_funcs:
        ...
        if current_device == "iluvatar_gpu" or current_device == "musa":
            current_device = "gpu"
        command = (
            f"python -m paddle.distributed.launch --log_dir {paddlefleet_dist_log} "
