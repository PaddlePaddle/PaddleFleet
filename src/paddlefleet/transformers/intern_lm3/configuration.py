...
from paddlefleet.transformers.modeling_rope_utils import rope_config_validation
...
class InternLM3Config(PretrainedConfig):
    ...
    Example:
        >>> from paddlefleet.transformers.intern_lm3 import InternLM3Config, InternLM3Model
