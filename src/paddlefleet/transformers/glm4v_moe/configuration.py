...
class Glm4vMoeVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from paddlefleet.transformers import Glm4vMoeVisionConfig, Glm4vMoeVisionModel
...
class Glm4vMoeTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from paddlefleet.transformers import Glm4vMoeTextModel, Glm4vMoeConfig
...
class Glm4vMoeConfig(PretrainedConfig):
    ...
    ```python
    >>> from paddlefleet.transformers import Glm4vMoeForConditionalGeneration, Glm4vMoeConfig
