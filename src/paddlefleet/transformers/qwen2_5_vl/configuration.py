...
class Qwen2_5_VLTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from paddlefleet.transformers import Qwen2_5_VLTextModel, Qwen2_5_VLConfig
...
class Qwen2_5_VLConfig(PretrainedConfig):
    ...
    ```python
    >>> from paddlefleet.transformers import Qwen2_5_VLForConditionalGeneration, Qwen2_5_VLConfig
