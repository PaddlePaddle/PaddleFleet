...
class Qwen3_5TextConfig(PretrainedConfig):
    ...
    ```python
    >>> from paddlefleet.transformers import Qwen3VLMoeTextModel, Qwen3VLMoeConfig
...
class Qwen3_5Config(PretrainedConfig):
    ...
    ```python
    >>> from paddlefleet.transformers import Qwen3VLMoeForConditionalGeneration, Qwen3VLMoeConfig
