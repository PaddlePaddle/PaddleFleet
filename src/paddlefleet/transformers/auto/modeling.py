...
class _BaseAutoModelClass:
    ...
    def _get_model_class_from_config(
        ...
        model_name = (
            "MiniCPM4_1Model" if resolved_model_type == "minicpm4_1" else None
        )
        ...
        if init_class == "PaliGemmaForConditionalGeneration":
            import_class = importlib.import_module(
                "paddlefleet.transformers.paligemma2.modeling"
            )
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoBackbone
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoModel

                # Name of built-in pretrained model
                model = AutoModel.from_pretrained('bert-base-uncased')
                print(type(model))
                # <class 'paddlefleet.transformers.bert.modeling.BertModel'>
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoModelForPretraining
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoModelForSequenceClassification
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoModelForTokenClassification
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoModelForQuestionAnswering
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoModelForMultipleChoice
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoModelForMaskedLM
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoEncoder
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoDecoder
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoGenerator
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoDiscriminator
    ...
    def from_pretrained(
        ...
        Example:
            .. code-block::
                ...
                from paddlefleet.transformers import AutoModelForConditionalGeneration
