...
| PaddleFleet `transformers/hyperbody/` | HF-style config -> ``GPTConfig`` conversion + model assembly |

Geometry constants and ``GPTConfig`` assembly do not live here; they belong to the
"HF-style config to GPTConfig conversion" responsibility on the transformers side.
