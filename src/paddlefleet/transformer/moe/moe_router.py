...
# MD5 logging for MoE router precision debugging (受 GLM_ALIGN_LOG 控制)
_LOG_LAYER_MD5 = _is_log_enabled()
...
class StandardMoERouter(nn.Layer):
    def __init__(
        ...
        _gate_dtype = "bfloat16" if _is_bit_exact_align() else "float32"
