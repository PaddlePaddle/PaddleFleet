...
class MoELayer(nn.Layer):
    ...
    def custom_forward(
        ...
        if is_first_fwd and global_moe_balance_training_logs_enabled():
            log_moe_balance(
                self.layer_number,
                self.moe_group,
                self.num_experts_per_tok,
    ...
    def set_layer_number(self, layer_number):
        ...
        self.gate.moe_group = self.moe_group
        self.gate.moe_rank = self.moe_rank
        self.gate.num_experts_per_device = self.num_experts_per_device
        self.gate.expert_model_parallel_size = (
            self.expert_model_parallel_size
        )
