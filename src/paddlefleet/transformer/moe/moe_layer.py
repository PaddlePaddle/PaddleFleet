...
class MoELayer(nn.Layer):
    def __init__(
        ...
        if (
            ...
            and self.fp8
            and (self.use_w4a8 or self.using_sonic_moe)
        ):
            raise ValueError(
                "SiTU-GLU + fp8 is only supported on the DeepGEMM fp8 path; "
                "not yet on SonicMoE / w4a8. Disable fp8 or switch backend."
            )
