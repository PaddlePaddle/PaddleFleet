...
class MlpNode:
    ...
    def __init__(
        ...
        self.num_experts_per_device = getattr(
            custom_map, "num_experts_per_device", len(custom_map.experts)
        )
    ...
    def gemm_forward_subbatch(
        ...
        Example (expert_id=1, 该专家有 300 个 token, subbatch_rows=128):
            ...
            3. 写回结果:
               ...
               - unzipped_out 为 None → scatter-add 到 float32 累加器 (非 fusion)
    ...
    def forward_auto_subbatch(
        ...
        self._fwd_diag = {
            "total_tokens": num_unzipped_tokens,
            "subbatch_rows": subbatch_rows,
            "zip_unzip_fusion": zip_unzip_fusion,
            "path": fwd_path,
        }
