        ...
        if _need_per_expert_nodes:
            ...
            self.experts_group_gemm_node = [
                ExpertsGroupGemmContiguousNode(
                    ...
                    use_ue8m0=use_ue8m0,
                    defer_expert_up_gate_dw=defer_expert_up_gate_dw,
                    defer_expert_down_dw=defer_expert_down_dw,
...
def run_sonic_moe(
    ...
    # In-tree fallback (only reached when paddlefleet_ops.sonicmoe lacks
    # run_sonic_moe). Ensure this module's SonicMoE symbols are resolved even if
    # MoELayer did not preload them.
    _load_sonic_symbols()
