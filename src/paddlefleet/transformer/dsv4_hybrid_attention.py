...
class DSv4HybridAttention(Attention):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.pg_collection = kwargs.pop(
            "pg_collection",
            ProcessGroupCollection.use_mpu_process_groups(required_pgs=["tp", "cp"]),
        )
        ...
        if sublayers_spec.o_proj is not None:
            self.o_proj = build_spec_layer(
                ...
                input_size=linear_proj_in_size,
        ...
        **kwargs,
        ...
        if sublayers_spec.linear_q_up_proj is not None:
            self.linear_q_up_proj = build_spec_layer(
                ...
                output_size=self.num_attention_heads * q_head_dim,
                config=config,
