...
PaddleFleet must not grow a dependency on any particular profiler.
...
callable::
    ...
    from paddlefleet.trainer.startup_profile import set_span_provider
...
every standalone PaddleFleet user -- :func:`span` returns a shared no-op object,
