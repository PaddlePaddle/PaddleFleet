...
class CheckpointConverter:
    ...
    def gen_metadata_and_prepare_source_state_dict(self):
        ...
        if (
            ...
            for (
                ...
                for item in shard_info:
                    ...
                    state_name_with_tp_rank = (
                        state_name + "_tp" + "{:02d}".format(tp_rank)
                    )
            ...
            logger.info(
                "Completed the call _load_state_dict, concating back the tensors split by sharding."
            )
    ...
    def infer_is_sharding_stage3(self):
        ...
        state_dict_std = global_file_to_state_shape_mapping[
            list(global_file_to_state_shape_mapping.keys())[0]
        ]
