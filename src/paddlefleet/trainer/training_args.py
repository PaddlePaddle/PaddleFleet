...
class TrainingArguments:
    ...
    Parameters:
        ...
        do_train (`bool`, *optional*, defaults to `False`):
            ...
            scripts](https://github.com/PaddlePaddle/PaddleFleet/tree/develop/examples) for more details.
    ...
    output_signal_dir: Optional[str] = field(
    ...
    overlap_p2p_comm: bool = field(
        default=True,
        metadata={
            "help": "Whether to overlap point-to-point (P2P) communication with computation."
        },
    )
    ...
    def __post_init__(self):
        ...
        if self.use_flex_async_save:
            if self.save_checkpoint_format != "flex_checkpoint":
                raise ValueError(
                    "use_flex_async_save requires save_checkpoint_format='flex_checkpoint'"
                )
            ...
            if self.use_async_save:
                raise ValueError(
                    "use_flex_async_save and use_async_save are mutually exclusive"
                )
