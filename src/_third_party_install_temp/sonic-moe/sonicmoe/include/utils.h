...
// basic CUDA launch utils copied from https://github.com/open-lm-engine/accelerated-model-architectures/
...
template <typename T>
inline __device__ void store_128_bits(const T *source, T *destination, const uint64_t &index) {
